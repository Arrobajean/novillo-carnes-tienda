...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Redescubre la Plateada Vacuno, un corte excepcional proveniente del lateral del pecho, apreciado por su forma rectangular y su textura aplanada que resalta la jugosidad y el sabor concentrado. Ideal para preparaciones a la parrilla o al horno, este corte se convierte en la opción perfecta para los amantes del buen vacuno.",
    price: 12959,
