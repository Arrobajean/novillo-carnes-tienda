              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="bg-novillo-red hover:bg-red-900 transition-colors text-white p-3 rounded-full"
                  >
